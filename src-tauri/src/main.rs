...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::provider_commands::list_provider_oauth_profiles,
            commands::provider_commands::set_active_provider_oauth_profile,
            commands::provider_commands::rename_provider_oauth_profile,
            commands::provider_commands::delete_provider_oauth_profile,
